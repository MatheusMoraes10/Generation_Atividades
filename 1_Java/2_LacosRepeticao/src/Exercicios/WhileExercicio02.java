...
public class WhileExercicio02 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Total de pessoas desenvolvedoras Backend: "+ totback);
		System.out.println("Total de mulheres desenvolvedoras Frontend: "+mfront);
		System.out.println("Total de homens desenvolvedores Mobile maiores de 40 anos: "+hmobille);
		System.out.println("Total de mulheres desenvolvedoras FullStack menores de 30 anos: "+mfull);
	}
